(function () {
  ...
  function productTitle(product) {
    if (product.product_type === 'tire' && product.tire_size) {
      ...
      return product.tire_size + brand;
    }
  ...
  function productImage(product) {
    ...
    if (product.product_type === 'service') {
      visual.classList.add('catalog-product-visual--service');
  ...
  function quantityControl(product) {
    ...
    if (current === 0) {
      ...
      add.textContent = '+';
      add.addEventListener('click', function () { changeQuantity(product, 1); });
      return add;
    }
    ...
    minus.addEventListener('click', function () { changeQuantity(product, -1); });
    ...
    plus.addEventListener('click', function () { changeQuantity(product, 1); });
  ...
  function productCard(product) {
    ...
    name.textContent = product.product_type === 'tire' ? product.product_name : 'Serviço da Matriz';
