...
window.PAINEL_MONTAR = function (estado) {
  ...
  const fabricas = [
    ...
    window.PAINEL_MODULES.vendasLotes,
    ...
    window.PAINEL_MODULES.relatoriosDemanda,
    window.PAINEL_MODULES.relatoriosDemandaView,
    window.PAINEL_MODULES.relatoriosDemandaCharts,
    window.PAINEL_MODULES.relatoriosDemandaExport,
    window.PAINEL_MODULES.relatoriosDemandaPdf,
    ...
    window.PAINEL_MODULES.relatoriosParceirosExport,
    window.PAINEL_MODULES.relatoriosParceirosPdf,
    window.PAINEL_MODULES.relatoriosFinanceiro,
    window.PAINEL_MODULES.relatoriosFinanceiroView,
    window.PAINEL_MODULES.relatoriosFinanceiroCharts,
    window.PAINEL_MODULES.relatoriosFinanceiroExport,
    window.PAINEL_MODULES.relatoriosFinanceiroPdf,
    window.PAINEL_MODULES.relatoriosLogistica,
    window.PAINEL_MODULES.relatoriosLogisticaView,
    window.PAINEL_MODULES.relatoriosLogisticaExport,
    window.PAINEL_MODULES.relatoriosLogisticaPdf,
    window.PAINEL_MODULES.relatoriosCompras,
    window.PAINEL_MODULES.relatoriosEstoque,
    window.PAINEL_MODULES.relatoriosEstoqueView,
    window.PAINEL_MODULES.relatoriosEstoqueExport,
    window.PAINEL_MODULES.relatoriosEstoquePdf,
    window.PAINEL_MODULES.relatoriosComprasView,
    window.PAINEL_MODULES.relatoriosComprasExport,
    window.PAINEL_MODULES.relatoriosComprasPdf,
    window.PAINEL_MODULES.relatorios,
    window.PAINEL_MODULES.relatoriosView,
    window.PAINEL_MODULES.relatoriosExport,
    window.PAINEL_MODULES.relatoriosPdf,
    ...
    window.PAINEL_MODULES.clientesFicha, // ficha de leitura sem sair da lista de clientes
    ...
    window.PAINEL_MODULES.resumo,
    window.PAINEL_MODULES.resumoChart,
