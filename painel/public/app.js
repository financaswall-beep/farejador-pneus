...
function painelApp() {
  ...
  const estado = {
    ...
    marketingTab: 'visao', marketingPeriod: '30d', marketingVisao: null, marketingCampaignChannel: 'all', marketingCampaigns: null,
    marketingLoading: false, marketingError: null, marketingCampaignsLoading: false, marketingCampaignsError: null, marketingCampaignRequestSeq: 0, marketingCampaignSearch: '', marketingCampaignDecision: 'all', marketingCampaignPage: 1, marketingIntegrations: null, marketingIntegrationsLoading: false, marketingIntegrationsError: null, marketingIntegrationsMessage: '', marketingUtmForm: { base_url: '', source: 'meta', medium: 'paid_social', campaign: '', content: '' }, marketingUtmMessage: '',
    // ─── MENUS ──────────────────────────────────────
    liveMenu: [
