...
function painelApp() {
  ...
  const estado = {
    ...
    marketingLoading: false, marketingError: null, marketingCampaignsLoading: false, marketingCampaignsError: null, marketingCampaignRequestSeq: 0, marketingCampaignSearch: '', marketingCampaignDecision: 'all', marketingCampaignPage: 1, marketingJourneysLoading: false, marketingJourneysError: null, marketingIntegrations: null, marketingIntegrationsLoading: false, marketingIntegrationsError: null, marketingIntegrationsMessage: '', marketingIntegrationActionLoading: '', marketingUtmForm: { base_url: '', source: 'meta', medium: 'paid_social', campaign: '', content: '' }, marketingUtmMessage: '',
    // ─── MENUS ──────────────────────────────────────
    liveMenu: [
