...
function painelApp() {
  ...
  const estado = {
    ...
    atacadoForm: {
      ...
      items: [{ vehicle_type: '', measure: '', brand: '', tire_condition: '', quantity: 1, unit_price: '' }],
    },
    ...
    colabRemForm: { employment_type: 'clt', base_salary: '', salary_frequency: 'monthly', payment_day: 5, payment_method: 'pix', payment_note: '', starts_on: '', benefits: [] }, colabComForm: { kind: 'percent', basis: 'margin', value: '', starts_on: '', active: true, settlement_frequency: 'monthly', itemized: false, item_rules: { tire: { kind: 'none', value: 0 }, service: { kind: 'none', value: 0 }, other: { kind: 'none', value: 0 } } }, colabPermForm: { resumo: false, bot: false, vendas: false, retiradas: false, clientes: false, compras: false, estoque: false, logistica: false, financeiro: false, rede: false, marketing: false, colaboradores: false, catalogo: false }, colabPermAvailable: [], colabPermLocked: false, colabPermLoading: false, colabPermissionModel: 'custom', colabAjusteForm: { kind: 'addition', description: '', amount: '' }, colabPerfilForm: { job_title: '', work_area: 'other' },
    ...
    mcoData: null, mcoSelected: null, mcoPage: 1, mcoLoading: false, mcoBusy: false, mcoError: '', mcoRequestSeq: 0, mcoConnectionMessage: '',
