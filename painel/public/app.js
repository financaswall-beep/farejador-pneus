...
function painelApp() {
  ...
  const estado = {
    ...
    colabRemForm: { employment_type: 'clt', base_salary: '', salary_frequency: 'monthly', payment_day: 5, payment_method: 'pix', payment_note: '', starts_on: '', benefits: [] }, colabComForm: { kind: 'percent', basis: 'margin', value: '', starts_on: '', active: true, settlement_frequency: 'monthly', itemized: false, item_rules: { tire: { kind: 'none', value: 0 }, service: { kind: 'none', value: 0 }, other: { kind: 'none', value: 0 } } }, colabPermForm: { vendas: false, estoque: false, entregas: false, financeiro: false }, colabPermAvailable: [], colabPermLocked: false, colabPermLoading: false, colabPermissionModel: 'custom', colabAjusteForm: { kind: 'addition', description: '', amount: '' }, colabPerfilForm: { job_title: '', work_area: 'other' },
