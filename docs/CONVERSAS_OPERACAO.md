...
- A ficha exibe o VIP calculado pelas compras concluídas, formata telefones brasileiros e permite copiar o número e carregar mais compras. Os interesses usam as imagens de carro/moto do catálogo somente quando a classificação da medida é inequívoca; sem classificação, usam ícone neutro. A consulta acontece ao abrir a ficha, sem alterar o cadastro, os totais ou a atualização das mensagens.
