...
const scripts=['app.relatorios.js','app.relatorios.view.js','app.relatorios.export.js','app.relatorios.pdf.js'];
...
(async()=>{
 ...
 try{
  ...
  assert.equal(await page.locator('.rp-tabs [aria-selected=true]').innerText(),'Vendas');
