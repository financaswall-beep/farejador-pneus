...
const scripts=['app.relatorios.pdf.core.js','app.relatorios.compras.js','app.relatorios.compras.view.js','app.relatorios.compras.export.js','app.relatorios.compras.pdf.js','app.relatorios.js','app.relatorios.view.js','app.relatorios.export.js','app.relatorios.pdf.js'];
