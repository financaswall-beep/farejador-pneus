...
const scripts=['app.relatorios.logistica.js','app.relatorios.logistica.view.js','app.relatorios.logistica.export.js','app.relatorios.logistica.pdf.js','app.relatorios.pdf.core.js','app.relatorios.estoque.js','app.relatorios.estoque.view.js','app.relatorios.estoque.export.js','app.relatorios.estoque.pdf.js','app.relatorios.compras.js','app.relatorios.compras.view.js','app.relatorios.compras.export.js','app.relatorios.compras.pdf.js','app.relatorios.js','app.relatorios.view.js','app.relatorios.export.js','app.relatorios.pdf.js'];
