...
const modules=['app.relatorios.pdf.core.js','app.compras.reposicao.js','app.galpao.multibrand.js',...['estoque','compras'].flatMap(name=>['','.view','.export','.pdf'].map(suffix=>'app.relatorios.'+name+suffix+'.js')),...['','.view','.export','.pdf'].map(suffix=>'app.relatorios'+suffix+'.js')];
