...
export function registerCaixaStaticRoutes(fastify: FastifyInstance, flagGate: FlagGate): void {
  ...
  text('/operacao/catalog-create-utils.js', 'catalog-create-utils.js', 'text/javascript; charset=utf-8');
  ...
  text('/operacao/caixa-pickups-core.js', 'caixa-pickups-core.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-pickups-sheet.js', 'caixa-pickups-sheet.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-pickups-actions.js', 'caixa-pickups-actions.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-sales.js', 'caixa-sales.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases.js', 'caixa-purchases.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases-list.js', 'caixa-purchases-list.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases-items.js', 'caixa-purchases-items.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases-review.js', 'caixa-purchases-review.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases-wizard.js', 'caixa-purchases-wizard.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases-detail.js', 'caixa-purchases-detail.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchases.css', 'caixa-purchases.css', 'text/css; charset=utf-8');
  text('/operacao/purchase-price-utils.js', 'purchase-price-utils.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchase-prices.js', 'caixa-purchase-prices.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchase-prices-detail.js', 'caixa-purchase-prices-detail.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-purchase-prices.css', 'caixa-purchase-prices.css', 'text/css; charset=utf-8');
  text('/operacao/catalog-tire-car.png', 'assets/catalog-tire-car.png', 'image/png', 'public, max-age=31536000, immutable');
  ...
  text('/operacao/caixa-finance-matrix.css', 'caixa-finance-matrix.css', 'text/css; charset=utf-8');
  text('/operacao/caixa-finance-view.js', 'caixa-finance-view.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-finance-matrix.js', 'caixa-finance-matrix.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-finance-accounts.css', 'caixa-finance-accounts.css', 'text/css; charset=utf-8');
  ...
  text('/operacao/expense-receipt-viewer.js', 'expense-receipt-viewer.js', 'text/javascript; charset=utf-8');
  text('/operacao/caixa-finance-receipts.js', 'caixa-finance-receipts.js', 'text/javascript; charset=utf-8');
