...
export async function registerPainelStatic(fastify: FastifyInstance): Promise<void> {
  ...
  const painelModulos = [
    ...
    'mapa-rm-dados.js', 'app.bot.js', 'app.bot.movimento.js', 'app.bot.mapa.js', 'app.clientes.js', 'app.clientes.kanban.js', 'app.clientes.leads.js', 'app.clientes.identity.js',
