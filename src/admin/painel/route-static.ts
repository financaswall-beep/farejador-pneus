...
export async function registerPainelStatic(fastify: FastifyInstance): Promise<void> {
  ...
  const painelModulos = [
    ...
    'app.galpao.contagem.js', 'app.galpao.ajuste.js', 'app.galpao.multibrand.js', 'app.galpao.correcao.js', 'app.galpao.js', 'app.catalogo.js', 'app.catalogo.compatibilidade.js', 'app.rede.apply.js', 'app.pedidos.parceiros.js', 'app.core.js',
