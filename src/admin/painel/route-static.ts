...
export async function registerPainelStatic(fastify: FastifyInstance): Promise<void> {
  ...
  const painelModulos = [
    'app.nav.js', 'app.rede.kpis.js', 'app.rede.operacao.js', 'app.unidade.kpis.js', 'app.venda.modal.js', 'app.api.js', 'app.municipios.js',
    'business-time.js', 'app.format.js', 'app.varejo.js', 'app.vendas.marcas.js', 'app.vendas.historico.js', 'app.comissoes.js', 'app.atacado.js', 'app.atacado.transfer.js', 'app.compras.js', 'app.compras.relatorios.js', 'app.compras.acoes.js',
    ...
    'mapa-rm-dados.js', 'app.bot.js', 'app.bot.mapa.js', 'app.clientes.js', 'app.clientes.kanban.js', 'app.clientes.identity.js',
