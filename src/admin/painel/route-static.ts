...
export async function registerPainelStatic(fastify: FastifyInstance): Promise<void> {
  ...
  const painelModulos = [
    'app.nav.js', 'app.rede.kpis.js', 'app.rede.operacao.js', 'app.unidade.kpis.js', 'app.venda.modal.js', 'app.api.js', 'app.partner-api.js', 'app.partner-resumo.js', 'app.municipios.js',
