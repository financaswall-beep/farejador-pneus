...
export async function registerPainelStatic(fastify: FastifyInstance): Promise<void> {
  ...
  const painelModulos = [
    ...
    'app.logistica.acoes.js', 'app.colaboradores.js', 'app.colaboradores.gestao.js', 'app.colaboradores.finance.js', 'app.colaboradores.permissions.js', 'app.colaboradores.performance.js', 'app.sino.js', 'app.financeiro.js',
