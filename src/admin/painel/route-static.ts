...
export async function registerPainelStatic(fastify: FastifyInstance): Promise<void> {
  ...
  const painelModulos = [
    ...
    'app.format.js', 'app.varejo.js', 'app.vendas.marcas.js', 'app.vendas.historico.js', 'app.comissoes.js', 'app.atacado.js', 'app.atacado.transfer.js', 'app.compras.js', 'app.compras.relatorios.js', 'app.compras.acoes.js',
