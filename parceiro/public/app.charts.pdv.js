      ...
      window._posSparkChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            borderColor: this.theme === 'light' ? '#047857' : '#facc15',
            backgroundColor: this.theme === 'light' ? 'rgba(4,120,87,.12)' : 'rgba(250,204,21,.12)',
            borderWidth: 2,
            tension: .35,
            pointRadius: 0,
            fill: true,
      ...
      window._financeRevenuePosChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Vendas',
            data: series.map((d) => d.value),
            borderColor: light ? '#047857' : '#ffd000',
            backgroundColor: light ? 'rgba(4, 120, 87, 0.10)' : 'rgba(255, 208, 0, 0.14)',
            fill: true,
            tension: 0.36,
            pointRadius: 2.4,
            pointHoverRadius: 4,
            pointBackgroundColor: light ? '#047857' : '#ffd000',
            borderWidth: 2,
          }],
        },
        options: {
