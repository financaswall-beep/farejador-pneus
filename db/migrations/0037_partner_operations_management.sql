-- 0037_partner_operations_management.sql
-- Completa gerenciamento MVP do Portal Parceiro:
-- - cancelamento logico de compras
-- - resumo ignora compras canceladas e despesas removidas
-- - nada toca em bot/shadow/Chatwoot.

ALTER TABLE commerce.partner_purchases
  ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS deleted_by TEXT;

CREATE INDEX IF NOT EXISTS partner_purchases_unit_active_date_idx
...
COMMENT ON VIEW network.partner_unit_summary IS
  'Resumo seguro do portal parceiro. Uma linha por unidade, sem dados de bot/shadow. Pedidos cancelados, compras canceladas e despesas removidas nao entram no total.';
