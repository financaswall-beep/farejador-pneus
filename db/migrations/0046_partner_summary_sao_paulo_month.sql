-- 0046_partner_summary_sao_paulo_month.sql
-- Ajusta o resumo mensal do Portal Parceiro para usar a virada do mes em
-- America/Sao_Paulo. Evita erro de fuso nas primeiras horas do mes.
...
COMMENT ON VIEW network.partner_unit_summary IS
  'Resumo seguro do portal parceiro. Soma vendas, compras e despesas locais do mes em America/Sao_Paulo e preserva security_invoker para RLS.';
