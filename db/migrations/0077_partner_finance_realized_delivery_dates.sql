-- 0077: Financeiro usa data de realizacao para delivery/COD.
-- Aplicada em prod em 2026-05-31 por Codex.
--
-- Regra 0076:
--   - pickup/balcao: venda realizada em partner_orders.created_at;
--   - delivery/COD: pedido aberto e reserva nao sao venda realizada;
--   - delivery vira venda/CGV no momento da entrega: partner_orders.delivered_at.
--
-- Sem isto, um pedido criado no fim do mes e entregue no mes seguinte poderia ficar
-- fora do mes correto em sales_month/orders_month/cogs_month.
