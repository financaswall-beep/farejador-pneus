...
describe('Retiradas dentro da Operação da Loja', () => {
  ...
  it('acrescenta a aba no casco existente sem criar outro aplicativo', () => {
    ...
    expect(html).toContain('/operacao/caixa-pickups-core.js?v=20260823-pickups-mobile1');
    expect(html).toContain('/operacao/caixa-pickups-sheet.js?v=20260823-pickups-mobile1');
    expect(html).toContain('/operacao/caixa-pickups-actions.js?v=20260823-pickups-mobile1');
