...
describe('ranking de marcas em Vendas', () => {
  ...
  it('expõe o ranking na Visão geral e registra o módulo estático', () => {
    ...
    expect(html).toContain('data-testid="sales-commercial-vision"');
    expect(html).toContain('data-testid="sales-channel-performance"');
    expect(html).toContain('data-testid="sales-commercial-focus"');
    ...
    expect(html).toContain('shadow-sm xl:col-span-5');
    expect(html).toContain('shadow-sm xl:col-span-3');
    expect(html).toContain('shadow-sm xl:col-span-4');
